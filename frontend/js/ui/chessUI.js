...
class ChessUI {
    ...
    highlightPossibleMoves(row, col) {
        ...
        for (let r = 0; r < ChessConfig.BOARD_SIZE; r++) {
            for (let c = 0; c < ChessConfig.BOARD_SIZE; c++) {
                if (this.engine.isValidMove(row, col, r, c)) {
    ...
    updateCapturedPieces() {
        ...
        this.capturedPiecesElement.textContent = 
            capturedPieces.map(piece => ChessConfig.pieces[piece]).join(' ');
    }
